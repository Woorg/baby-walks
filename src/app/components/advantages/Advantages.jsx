	...
	const data = {
		...
		list: [
			...
			},
			{
				...
				text: 'Использование нашего курса не просто даст Вам ценные навыки в уходе за ребёнком, но и сделает этот процесс незабываемым. Взаимодействуя с передовыми технологиями, Вы будете на голову выше тех, кто придерживается традиционных методов. Этот опыт не только обогатит вашу жизнь новыми знаниями, но и даст ам ощущение уверенности и современности в роли родителя.',
			},
			{
