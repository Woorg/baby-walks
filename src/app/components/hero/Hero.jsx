...
const Hero = () => {
	const data = {
		intro: {
			...
			text: '<p>Обеспечьте своему малышу наилучший уход! <br/>Узнайте все тонкости воспитания новорождённого с помощью подробного руководства на первые 12 месяцев.</p>',
